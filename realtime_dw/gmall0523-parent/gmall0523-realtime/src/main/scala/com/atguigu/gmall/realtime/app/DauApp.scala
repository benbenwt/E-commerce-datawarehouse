...
object DauApp {
  def main(args: Array[String]): Unit = {
    ...
    //rdd，从kafka创建的rdd，什么形式key，value类型
    ...
    //多个jsonobject，每个kafka的value返回了一个jsonobject，所以是一个jsonobj的迭代器。
    ...
    //将数据批量的保存到ES中
    //是什么，是有多个分区的数据，每个分区有一个filteredList，就是一个jsonobj的迭代器。
      ...
      rdd=>{
        ...
        rdd.foreachPartition{
          jsonObjItr=>{
            ...
            MyESUtil.bulkInsert(dauInfoList,"gmall2020_dau_info_20220418")
          }
        }
        //提交偏移量到Redis中
