...
object OrderWideApp {
  def main(args: Array[String]): Unit = {
    ...
    orderInfoWithKeyDStream.print(1000)
    orderDetailWithKeyDStream.print(1000)
    //双流join
    ...
    orderWideSplitDStream.foreachRDD{
      rdd=>{
        ...
        df.write.mode(SaveMode.Append)
          ...
          .jdbc("jdbc:clickhouse://172.18.65.186:8123/default","t_order_wide_2020",new Properties())
